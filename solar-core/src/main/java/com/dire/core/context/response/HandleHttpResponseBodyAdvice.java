...
public class HandleHttpResponseBodyAdvice implements ResponseBodyAdvice<Object> {

    private ResponseBodyHandler responseBodyHandler;

    public HandleHttpResponseBodyAdvice(ResponseBodyHandler responseBodyHandler) {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType, Class<? extends HttpMessageConverter<?>> selectedConverterType, ServerHttpRequest request, ServerHttpResponse response) {
        return responseBodyHandler.handle(body);
    }
